...
type
  TAssistBackFM = class(TBaseGrdFM)
    Label11: TLabel;
    ...
    Panel1: TPanel;
    cxbtnDetAdd: TcxButton;
    cxbtnDetDel: TcxButton;
    cxPageControl1: TcxPageControl;
    cxTabSheet1: TcxTabSheet;
    Panel2: TPanel;
    cxbtnDet2Add: TcxButton;
    cxbtnDet2Del: TcxButton;
    cxgrd1: TcxGrid;
    ...
    cxgrdbclmn1WareNum: TcxGridDBColumn;
    ...
    procedure cxbtnDetAddClick(Sender: TObject);
    procedure cxbtnDetDelClick(Sender: TObject);
    procedure cxbtnDet2AddClick(Sender: TObject);
    procedure cxbtnDet2DelClick(Sender: TObject);
    ...
    procedure cxgrdbtblvw1Column1PropertiesButtonClick(Sender: TObject;
      AButtonIndex: Integer);
    procedure strngfldHedAcceptIdChange(Sender: TField);
  private
...
var
  AssistBackFM: TAssistBackFM;

implementation

uses PublicPS, ControlPublicPS, DataPS, EmpQPS, ItemQPS, WareQPS, DeptQPS, PrvQPS, ItemMoveFindPS, InProDispatchRfPS, SGeneralPS;
{$R *.dfm}

procedure TAssistBackFM.SetEditState();
begin
  cxbtnDetAdd.Enabled := not btEdit.Enabled;
  cxbtnDetDel.Enabled := not btEdit.Enabled;
  cxbtnDet2Add.Enabled := not btEdit.Enabled;
  cxbtnDet2Del.Enabled := not btEdit.Enabled;
end;

procedure TAssistBackFM.GetDet2Num;
var i: integer;
begin
  try
    qyDet2.First;
...
procedure TAssistBackFM.MenuItem4Click(Sender: TObject);
begin
  inherited;
  CustomGrd(cxgrd1);
end;

procedure TAssistBackFM.MenuItem5Click(Sender: TObject);
begin
  inherited;
  SaveGrd(Self, cxgrdbtblvw1);
end;

procedure TAssistBackFM.MenuItem6Click(Sender: TObject);
begin
  inherited;
  DelGrd(Self, cxgrdbtblvw1);
end;

procedure TAssistBackFM.mniNCopyDClick(Sender: TObject);
begin
  inherited;
  CopyCellValue(cxgrdbtblvw1);
end;

procedure TAssistBackFM.mniNCopyLClick(Sender: TObject);
begin
  try
...
procedure TAssistBackFM.btAddClick(Sender: TObject);
begin
  try
...
procedure TAssistBackFM.btCancelClick(Sender: TObject);
begin
  qyDet2.Filter := '';
...
procedure TAssistBackFM.btCheckClick(Sender: TObject);
var i: Integer;
begin
  try
    ...
    begin
      try
        ...
        begin
          ...
          SQL.Clear;
          SQL.Add('Exec PrCheckMoveBackNum ' + QuotedStr(Trim(cxEdtNo.text)) + ',1');
          Open;
        end;
      ...
      begin
        try
          ...
          begin
            if Active then Close;
            SQL.Clear;
            SQL.Add('Exec PrItemMoveBackAudit ' + QuotedStr(Trim(cxEdtNo.text)) + ',1');
            Open;
          end;
        finally
          DataFM.qyTemp.close;
...
procedure TAssistBackFM.btDelClick(Sender: TObject);
var
  sBiilNo: string;
begin
...
procedure TAssistBackFM.btEditClick(Sender: TObject);
var i: integer;
begin
...
procedure TAssistBackFM.btFindClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TAssistBackFM.btRefClick(Sender: TObject);
begin
  try
    inherited;
...
procedure TAssistBackFM.btReferClick(Sender: TObject);
var
  i: integer;
begin
 ...
 { if cxBtnSendName.Text = '' then
  ...
  try
    ...
    InProDispatchRfFM.sKind := '外协返工出库';
...
procedure TAssistBackFM.btSaveClick(Sender: TObject);
var
  sNewNo: string;
  i: Integer;
begin
...
procedure TAssistBackFM.btUnCheckClick(Sender: TObject);
begin
  try
    if (trim(cxEdtNo.Text) = '') or (qyHed.Active = false) then exit;
    qyHed.UpdateCursorPos;
...
procedure TAssistBackFM.cxBt1PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
...
procedure TAssistBackFM.cxBt2PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
    try
      ...
      begin
        if qyHed.State = dsBrowse then qyHed.Edit;
        qyHed.FieldByName('AcceptId').AsString := PrvQFM.sId;
      end;
    finally
      PrvQFM.Free;
      PrvQFM := nil;
...
procedure TAssistBackFM.cxBtnInWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TAssistBackFM.cxbtnDet2AddClick(Sender: TObject);
begin
  inherited;
  try
    qyDet2.Append;
...
procedure TAssistBackFM.cxbtnDet2DelClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TAssistBackFM.cxbtnDetAddClick(Sender: TObject);
begin
  try
    inherited;
    qyDet.Append;
...
procedure TAssistBackFM.cxbtnDetDelClick(Sender: TObject);
var i: Integer;
begin
  try
    qyDet2.First;
...
procedure TAssistBackFM.cxBtnOutWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TAssistBackFM.cxDetAutoNoPropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TAssistBackFM.cxEdtNoPropertiesChange(Sender: TObject);
begin
  inherited;
  with qyDet do
  begin
...
procedure TAssistBackFM.cxgrdbclmnColumn4PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TAssistBackFM.cxgrdbclmnColumn6PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TAssistBackFM.cxgrdbclmncxgrdbtblvw1ExchRatePropertiesValidate(
...
procedure TAssistBackFM.cxgrdbclmncxgrdbtblvw1ItemCodePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TAssistBackFM.cxgrdbclmncxgrdbtblvw1MoveNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdbclmncxgrdbtblvw1SubNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdbclmnItemCodePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TAssistBackFM.cxgrdbclmnItemPYCodePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdbclmnOrderNumPropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TAssistBackFM.cxgrdbclmnOrderPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TAssistBackFM.cxgrdbclmnTaxPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TAssistBackFM.cxgrdbclmnTaxRatePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TAssistBackFM.cxgrdbtblvw1Column1PropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    ...
    SGeneralFM.sWhere := ' and a.ItemId=' + QuotedStr(qyDet2.FieldByName('ItemId').AsString);
...
procedure TAssistBackFM.cxgrdbtblvw1CustomDrawIndicatorCell(
...
procedure TAssistBackFM.cxgrdtbvColumn3PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdtbvColumn5PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdtbvColumn7PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TAssistBackFM.cxgrdtbvCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
var
  ARec: TRect;
begin
  inherited;
  if (AViewInfo.GridRecord.DisplayTexts[cxgrdbclmnMoveNum.Index] <> '') and (AViewInfo.GridRecord.DisplayTexts[cxgrdbclmnWareNum.Index] <> '') then
  begin
    if (not qyHed.FieldByName('bMaxAudit').AsBoolean)
      and (StrToFloat(AViewInfo.GridRecord.DisplayTexts[cxgrdbclmnMoveNum.Index]) > StrToFloat(AViewInfo.GridRecord.DisplayTexts[cxgrdbclmnWareNum.Index])) then
    begin
...
procedure TAssistBackFM.dxbrbtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TAssistBackFM.dxbrbtn2Click(Sender: TObject);
begin
  inherited;
...
procedure TAssistBackFM.FormCreate(Sender: TObject);
begin
  sFMId := 'AssistBackFM';
...
procedure TAssistBackFM.FormDestroy(Sender: TObject);
begin
  inherited;
  AssistBackFM := nil;
end;

procedure TAssistBackFM.FormShow(Sender: TObject);
var i: Integer;
begin
  inherited;
  SetEditState();
...
procedure TAssistBackFM.qyDet2AfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TAssistBackFM.qyDet2CalcFields(DataSet: TDataSet);
begin
  inherited;
  CalcField(qyDet2, DataFM.qyObject, ['ObjectId', 'ObjectName'], ['ObjectId', 'ObjectName']);
  if qyWareNum.Locate('sInfo', qyDet2.FieldByName('ItemId').AsString + qyHed.FieldByName('InWare').AsString + qyDet2.FieldByName('ProType').AsString + qyDet2.FieldByName('Color').AsString + qyDet2.FieldByName('PlaceNo').AsString + qyDet2.FieldByName('ObjectId').AsString + qyDet2.FieldByName('TechName').AsString, []) then
    qyDet2.FieldByName('WareNum').AsFloat := qyWareNum.FieldByName('WareNum').AsFloat
  else
    qyDet2.FieldByName('WareNum').AsFloat := 0;
end;

procedure TAssistBackFM.qyDetAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TAssistBackFM.qyDetCalcFields(DataSet: TDataSet);
begin
  inherited;
  ...
  if qyWareNum.Locate('sInfo', qyDet.FieldByName('ItemId').AsString + qyHed.FieldByName('OutWare').AsString + qyDet.FieldByName('ProType').AsString + qyDet.FieldByName('Color').AsString + qyDet.FieldByName('PlaceNo').AsString + qyDet.FieldByName('ObjectId').AsString+ qyDet.FieldByName('TechName').AsString, []) then
    qyDet.FieldByName('WareNum').AsFloat := qyWareNum.FieldByName('WareNum').AsFloat
  else
    qyDet.FieldByName('WareNum').AsFloat := 0;
end;

procedure TAssistBackFM.qyDetMoveNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TAssistBackFM.qyDetScrapNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TAssistBackFM.qyDetScrapPriceChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TAssistBackFM.qyDetSpoilNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TAssistBackFM.qyDetWasteNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TAssistBackFM.qyHedCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TAssistBackFM.qyHedPrintNumChange(Sender: TField);
begin
  inherited;
  ShowFMInfo(sTableId, qyHed);
end;

procedure TAssistBackFM.strngfldDet2ItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TAssistBackFM.strngfldDetItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TAssistBackFM.strngfldDetTechNameChange(Sender: TField);
var i: integer;
begin
  try
...
procedure TAssistBackFM.strngfldHedAcceptIdChange(Sender: TField);
var i: Integer;
begin
  inherited;
  qyDet2.First;
  ...
  begin
    if qyDet2.State = dsBrowse then qyDet2.Edit;
    qyDet2.FieldByName('ObjectId').AsString := qyHed.FieldByName('AcceptId').AsString;
    qyDet2.Next;
  end;
end;
