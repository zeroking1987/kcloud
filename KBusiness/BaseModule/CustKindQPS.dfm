object CustKindQFM: TCustKindQFM
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = #23458#25143#31867#21035#26597#35810
  ClientHeight = 401
  ClientWidth = 338
  Color = clBtnFace
  ...
  object lstTreeList: TcxDBTreeList
    ...
    DataController.KeyField = 'CustKindId'
    ...
    object cxDBTreeList1PrvKindId: TcxDBTreeListColumn
      Visible = False
      DataBinding.FieldName = 'CustKindId'
    ...
    object cxDBTreeList1PrvKindCode: TcxDBTreeListColumn
      ...
      DataBinding.FieldName = 'CustKindCode'
      Options.Editing = False
      Width = 108
      Position.ColIndex = 2
      Position.RowIndex = 0
  ...
  object qyFind: TADOQuery
    ...
    object qyFindCustKindId: TStringField
      FieldName = 'CustKindId'
    end
    object qyFindCustKindCode: TStringField
      FieldName = 'CustKindCode'
    end
    object qyFindCustKindName: TStringField
      FieldName = 'CustKindName'
      Size = 30
    end
    object qyFindCustParam: TStringField
      FieldName = 'CustParam'
      Size = 10
    end
