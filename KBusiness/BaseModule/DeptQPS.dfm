object DeptQFM: TDeptQFM
  ...
  object lstTreeList: TcxDBTreeList
    ...
    DataController.KeyField = 'DeptId'
    ...
    object cxDBTreeList1DeptId: TcxDBTreeListColumn
      Visible = False
      Caption.Text = #37096#38376#32534#21495
    ...
    object cxDBTreeList1DeptCode: TcxDBTreeListColumn
      Caption.Text = #37096#38376#20195#21495
      DataBinding.FieldName = 'DeptCode'
      Options.Editing = False
      Width = 85
      Position.ColIndex = 2
      Position.RowIndex = 0
    ...
    object cxDBTreeList1DeptName: TcxDBTreeListColumn
      Caption.Text = #37096#38376#21517#31216
    ...
    object lstTreeListcxDBTreeListColumn1: TcxDBTreeListColumn
      Caption.Text = #23545#24212#20179#24211
  ...
  object qyFind: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select a.*,b.WareName from DeptTB a left join WareTB b on a.Ware' +
        'Id=b.WareId')
    Left = 136
    Top = 176
    ...
    object qyFindDeptId: TStringField
      FieldName = 'DeptId'
    end
    object qyFindDeptCode: TStringField
      FieldName = 'DeptCode'
    end
    object qyFindDeptName: TStringField
      FieldName = 'DeptName'
      Size = 30
    end
