object PrvKindQFM: TPrvKindQFM
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = #20379#24212#21830#31867#21035#26597#35810
  ClientHeight = 401
  ClientWidth = 338
  Color = clBtnFace
  ...
  object lstTreeList: TcxDBTreeList
    ...
    DataController.KeyField = 'PrvKindId'
    ...
    object cxDBTreeList1PrvKindId: TcxDBTreeListColumn
      Visible = False
      DataBinding.FieldName = 'PrvKindId'
    ...
    object cxDBTreeList1PrvKindCode: TcxDBTreeListColumn
      Caption.Text = #31867#21035#20195#21495
      DataBinding.FieldName = 'PrvKindCode'
      Options.Editing = False
      Width = 114
      Position.ColIndex = 2
      Position.RowIndex = 0
    ...
    object cxDBTreeList1PrvKindName: TcxDBTreeListColumn
  ...
  object qyFind: TADOQuery
    ...
    object strngfldFindPrvKindId: TStringField
      FieldName = 'PrvKindId'
    end
    object strngfldFindPrvKindCode: TStringField
      FieldName = 'PrvKindCode'
    end
    object strngfldFindPrvKindName: TStringField
    ...
    object strngfldFindPrvParam: TStringField
      FieldName = 'PrvParam'
      Size = 10
    end
