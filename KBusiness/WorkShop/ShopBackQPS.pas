...
procedure TShopBackQFM.btFindClick(Sender: TObject);
begin
  sWhere := '';
  ...
  begin
    ...
    SQL.Clear;
    SQL.Add(' exec PrItemMoveQ ' + Quotedstr(sWhere) + ',' + Quotedstr('''ShopBack'''));
    Open;
  end;
...
procedure TShopBackQFM.btnAcceptNamePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackQFM.btnEmpNamePropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  SelectDept2(btnSendName);
end;

procedure TShopBackQFM.btnItemKindPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackQFM.btnItemNamePropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  SelectItem2(cxItem);
end;

procedure TShopBackQFM.cxEmpPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
  SelectEmp2(cxEmp);
...
procedure TShopBackQFM.cxgrdtbvDblClick(Sender: TObject);
begin
  inherited;
  BillView('ShopBack', 'select * from ItemMoveHDTB where MKindId=''ShopBack'' and  MoveNo=' + QuotedStr(qyHed.FieldByName('MoveNo').AsString));
end;

procedure TShopBackQFM.cxTechNamePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  try
...
procedure TShopBackQFM.FormCreate(Sender: TObject);
begin
  sFMId := 'ShopBackQFM';
...
procedure TShopBackQFM.FormDestroy(Sender: TObject);
begin
  inherited;
  ShopBackQFM := nil;
end;

procedure TShopBackQFM.FormShow(Sender: TObject);
begin
  inherited;
  with qyOutWare do
  begin
