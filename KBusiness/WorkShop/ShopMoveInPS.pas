...
type
  TShopMoveInFM = class(TBaseGrdFM)
    Label11: TLabel;
...
procedure TShopMoveInFM.SetEditState();
begin
...
procedure TShopMoveInFM.GetDet2Num;
var i: integer;
begin
  try
    qyDet2.First;
...
procedure TShopMoveInFM.MenuItem4Click(Sender: TObject);
begin
  inherited;
  CustomGrd(cxgrd1);
end;

procedure TShopMoveInFM.MenuItem5Click(Sender: TObject);
begin
  inherited;
  SaveGrd(Self, cxgrdbtblvw1);
end;

procedure TShopMoveInFM.MenuItem6Click(Sender: TObject);
begin
  inherited;
  DelGrd(Self, cxgrdbtblvw1);
end;

procedure TShopMoveInFM.mniNCopyDClick(Sender: TObject);
begin
  inherited;
  CopyCellValue(cxgrdbtblvw1);
end;

procedure TShopMoveInFM.mniNCopyLClick(Sender: TObject);
begin
  try
...
procedure TShopMoveInFM.btAddClick(Sender: TObject);
begin
  try
...
procedure TShopMoveInFM.btCancelClick(Sender: TObject);
begin
  qyDet2.Filter := '';
...
procedure TShopMoveInFM.btCheckClick(Sender: TObject);
var i: Integer;
begin
  try
...
procedure TShopMoveInFM.btDelClick(Sender: TObject);
var
  sBiilNo: string;
begin
...
procedure TShopMoveInFM.btEditClick(Sender: TObject);
var i: integer;
begin
...
procedure TShopMoveInFM.btFindClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TShopMoveInFM.btRefClick(Sender: TObject);
begin
  try
    inherited;
...
procedure TShopMoveInFM.btReferClick(Sender: TObject);
var
  i: integer;
begin
 ...
 { if cxBtnSendName.Text = '' then
  ...
  try
    ...
    InProDispatchRfFM.sKind := '车间加工入库';
...
procedure TShopMoveInFM.btSaveClick(Sender: TObject);
var
  sNewNo: string;
  i: Integer;
begin
...
procedure TShopMoveInFM.btUnCheckClick(Sender: TObject);
begin
  try
    if (trim(cxEdtNo.Text) = '') or (qyHed.Active = false) then exit;
    qyHed.UpdateCursorPos;
...
procedure TShopMoveInFM.cxBt1PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
...
procedure TShopMoveInFM.cxBt2PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
...
procedure TShopMoveInFM.cxBtnInWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveInFM.cxbtnOutAddClick(Sender: TObject);
begin
  inherited;
  try
    qyDet2.Append;
...
procedure TShopMoveInFM.cxbtnOutDelClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TShopMoveInFM.cxbtnInAddClick(Sender: TObject);
begin
  try
    inherited;
    qyDet.Append;
...
procedure TShopMoveInFM.cxbtnInDelClick(Sender: TObject);
var i: Integer;
begin
  try
    qyDet2.First;
...
procedure TShopMoveInFM.cxBtnOutWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveInFM.cxDetAutoNoPropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TShopMoveInFM.cxEdtNoPropertiesChange(Sender: TObject);
begin
  inherited;
  with qyDet do
  begin
...
procedure TShopMoveInFM.cxgrdbclmnColumn1PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
  try
...
procedure TShopMoveInFM.cxgrdbclmnColumn4PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TShopMoveInFM.cxgrdbclmnColumn6PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TShopMoveInFM.cxgrdbclmncxgrdbtblvw1ExchRatePropertiesValidate(
...
procedure TShopMoveInFM.cxgrdbclmncxgrdbtblvw1ItemCodePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TShopMoveInFM.cxgrdbclmncxgrdbtblvw1MoveNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TShopMoveInFM.cxgrdbclmncxgrdbtblvw1SubNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TShopMoveInFM.cxgrdbclmnItemCodePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TShopMoveInFM.cxgrdbclmnItemPYCodePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
procedure TShopMoveInFM.cxgrdbclmnOrderNumPropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TShopMoveInFM.cxgrdbclmnOrderPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TShopMoveInFM.cxgrdbclmnTaxPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TShopMoveInFM.cxgrdbclmnTaxRatePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TShopMoveInFM.cxgrdbtblvw1CustomDrawCell(
...
procedure TShopMoveInFM.cxgrdbtblvw1CustomDrawIndicatorCell(
...
procedure TShopMoveInFM.cxgrdtbvColumn11PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
  try
...
procedure TShopMoveInFM.cxgrdtbvColumn3PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveInFM.cxgrdtbvColumn5PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveInFM.cxgrdtbvColumn7PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveInFM.dxbrbtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TShopMoveInFM.dxbrbtn2Click(Sender: TObject);
begin
  inherited;
...
procedure TShopMoveInFM.FormCreate(Sender: TObject);
begin
  sFMId := 'ShopMoveInFM';
...
procedure TShopMoveInFM.FormDestroy(Sender: TObject);
begin
  inherited;
  ShopMoveInFM := nil;
end;

procedure TShopMoveInFM.FormShow(Sender: TObject);
var i: Integer;
begin
  inherited;
  SetEditState();
...
procedure TShopMoveInFM.qyDet2AfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopMoveInFM.qyDet2CalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopMoveInFM.qyDetAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopMoveInFM.qyDetCalcFields(DataSet: TDataSet);
begin
  inherited;
  ...
  if qyWareNum.Locate('sInfo', qyDet.FieldByName('ItemId').AsString + qyHed.FieldByName('InWare').AsString + qyDet.FieldByName('ProType').AsString + qyDet.FieldByName('Color').AsString + qyDet.FieldByName('PlaceNo').AsString + qyDet.FieldByName('ObjectId').AsString+ qyDet.FieldByName('TechName').AsString, []) then
    qyDet.FieldByName('WareNum').AsFloat := qyWareNum.FieldByName('WareNum').AsFloat
  else
    qyDet.FieldByName('WareNum').AsFloat := 0;
end;

procedure TShopMoveInFM.qyDetMoveNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopMoveInFM.qyDetScrapNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopMoveInFM.qyDetScrapPriceChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopMoveInFM.qyDetSpoilNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopMoveInFM.qyDetWasteNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopMoveInFM.qyHedCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopMoveInFM.qyHedPrintNumChange(Sender: TField);
begin
  inherited;
  ShowFMInfo(sTableId, qyHed);
end;

procedure TShopMoveInFM.strngfldDet2ItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TShopMoveInFM.strngfldDetItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TShopMoveInFM.strngfldDetTechNameChange(Sender: TField);
var i: integer;
begin
  try
