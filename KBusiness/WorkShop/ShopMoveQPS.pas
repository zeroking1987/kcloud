...
procedure TShopMoveQFM.btFindClick(Sender: TObject);
begin
  sWhere := '';
  ...
  begin
    ...
    SQL.Clear;
    SQL.Add(' exec PrItemMoveQ ' + Quotedstr(sWhere) + ',' + Quotedstr('''ShopMove'''));
    Open;
  end;
...
procedure TShopMoveQFM.btnAcceptNamePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveQFM.btnEmpNamePropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  SelectDept2(btnSendName);
end;

procedure TShopMoveQFM.btnItemKindPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopMoveQFM.btnItemNamePropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  SelectItem2(cxItem);
end;

procedure TShopMoveQFM.cxgrdtbvDblClick(Sender: TObject);
begin
  inherited;
  BillView('ShopMove', 'select * from ItemMoveHDTB where MKindId=''ShopMove'' and  MoveNo=' + QuotedStr(qyHed.FieldByName('MoveNo').AsString));
end;

procedure TShopMoveQFM.cxTechNamePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  try
...
procedure TShopMoveQFM.FormCreate(Sender: TObject);
begin
  sFMId := 'ShopMoveQFM';
...
procedure TShopMoveQFM.FormDestroy(Sender: TObject);
begin
  inherited;
  ShopMoveQFM := nil;
end;

procedure TShopMoveQFM.FormShow(Sender: TObject);
begin
  inherited;
  with qyOutWare do
  begin
