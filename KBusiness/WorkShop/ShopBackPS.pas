...
type
  TShopBackFM = class(TBaseGrdFM)
    ...
    cxgrd1bclmnWareNum: TcxGridDBColumn;
    ...
    procedure cxgrdtbvColumn11PropertiesButtonClick(Sender: TObject;
      AButtonIndex: Integer);
...
procedure TShopBackFM.SetEditState();
begin
...
procedure TShopBackFM.GetDet2Num;
var i: integer;
begin
  try
    qyDet2.First;
...
procedure TShopBackFM.MenuItem4Click(Sender: TObject);
begin
  inherited;
  CustomGrd(cxgrd1);
end;

procedure TShopBackFM.MenuItem5Click(Sender: TObject);
begin
  inherited;
  SaveGrd(Self, cxgrdbtblvw1);
end;

procedure TShopBackFM.MenuItem6Click(Sender: TObject);
begin
  inherited;
  DelGrd(Self, cxgrdbtblvw1);
end;

procedure TShopBackFM.mniNCopyDClick(Sender: TObject);
begin
  inherited;
  CopyCellValue(cxgrdbtblvw1);
end;

procedure TShopBackFM.mniNCopyLClick(Sender: TObject);
begin
  try
...
procedure TShopBackFM.btAddClick(Sender: TObject);
begin
  try
...
procedure TShopBackFM.btCancelClick(Sender: TObject);
begin
  qyDet2.Filter := '';
...
procedure TShopBackFM.btCheckClick(Sender: TObject);
var i: Integer;
begin
  try
...
procedure TShopBackFM.btDelClick(Sender: TObject);
var
  sBiilNo: string;
begin
...
procedure TShopBackFM.btEditClick(Sender: TObject);
var i: integer;
begin
...
procedure TShopBackFM.btFindClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TShopBackFM.btRefClick(Sender: TObject);
begin
  try
    inherited;
...
procedure TShopBackFM.btReferClick(Sender: TObject);
var
  i: integer;
begin
 ...
 { if cxBtnSendName.Text = '' then
  ...
  try
    ...
    InProDispatchRfFM.sKind := '车间返工出库';
...
procedure TShopBackFM.btSaveClick(Sender: TObject);
var
  sNewNo: string;
  i: Integer;
begin
...
procedure TShopBackFM.btUnCheckClick(Sender: TObject);
begin
  try
    if (trim(cxEdtNo.Text) = '') or (qyHed.Active = false) then exit;
    qyHed.UpdateCursorPos;
...
procedure TShopBackFM.cxBt1PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
...
procedure TShopBackFM.cxBt2PropertiesButtonClick(Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
  try
    if btSave.Enabled = False then Exit;
...
procedure TShopBackFM.cxBtnInWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackFM.cxbtnDet2AddClick(Sender: TObject);
begin
  inherited;
  try
    qyDet2.Append;
...
procedure TShopBackFM.cxbtnDet2DelClick(Sender: TObject);
begin
  inherited;
  try
...
procedure TShopBackFM.cxbtnDetAddClick(Sender: TObject);
begin
  try
    inherited;
    qyDet.Append;
...
procedure TShopBackFM.cxbtnDetDelClick(Sender: TObject);
var i: Integer;
begin
  try
    qyDet2.First;
...
procedure TShopBackFM.cxBtnOutWarePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackFM.cxDetAutoNoPropertiesChange(Sender: TObject);
begin
  inherited;
...
procedure TShopBackFM.cxEdtNoPropertiesChange(Sender: TObject);
begin
  inherited;
  with qyDet do
  begin
...
procedure TShopBackFM.cxgrdbclmnColumn4PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TShopBackFM.cxgrdbclmnColumn6PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := false;
...
procedure TShopBackFM.cxgrdbclmncxgrdbtblvw1ExchRatePropertiesValidate(
...
begin
  ...
  if DisplayValue = '' then
    DisplayValue := 0;
  qyDet2.FieldByName('ExchRate').AsFloat := DisplayValue;
  begin
    if qyDet2.FieldByName('iFlag').asInteger = 0 then
      qyDet2.FieldByName('SubNum').AsFloat := qyDet.FieldByName('MoveNum').AsFloat * DisplayValue
    else
    begin
      if DisplayValue <> 0 then
        qyDet2.FieldByName('SubNum').AsFloat := qyDet2.FieldByName('MoveNum').AsFloat / DisplayValue;
    end;
  end;
end;

procedure TShopBackFM.cxgrdbclmncxgrdbtblvw1ItemCodePropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TShopBackFM.cxgrdbclmncxgrdbtblvw1MoveNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TShopBackFM.cxgrdbclmncxgrdbtblvw1SubNumPropertiesValidate(
  Sender: TObject; var DisplayValue: Variant; var ErrorText: TCaption;
  var Error: Boolean);
begin
  inherited;
...
procedure TShopBackFM.cxgrdbclmnItemCodePropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
  i: Integer;
begin
...
procedure TShopBackFM.cxgrdbclmnItemPYCodePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
...
procedure TShopBackFM.cxgrdbclmnOrderNumPropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TShopBackFM.cxgrdbclmnOrderPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
  Error := False;
...
procedure TShopBackFM.cxgrdbclmnTaxPricePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TShopBackFM.cxgrdbclmnTaxRatePropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  try
    inherited;
...
procedure TShopBackFM.cxgrdbtblvw1CustomDrawIndicatorCell(
...
procedure TShopBackFM.cxgrdtbvColumn11PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
  try
...
procedure TShopBackFM.cxgrdtbvColumn3PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackFM.cxgrdtbvColumn5PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackFM.cxgrdtbvColumn7PropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
  inherited;
...
procedure TShopBackFM.cxgrdtbvCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
var
  ARec: TRect;
...
procedure TShopBackFM.dxbrbtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TShopBackFM.dxbrbtn2Click(Sender: TObject);
begin
  inherited;
...
procedure TShopBackFM.FormCreate(Sender: TObject);
begin
  sFMId := 'ShopBackFM';
...
procedure TShopBackFM.FormDestroy(Sender: TObject);
begin
  inherited;
  ShopBackFM := nil;
end;

procedure TShopBackFM.FormShow(Sender: TObject);
var i: Integer;
begin
  inherited;
  SetEditState();
...
procedure TShopBackFM.qyDet2AfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopBackFM.qyDet2CalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopBackFM.qyDetAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopBackFM.qyDetCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopBackFM.qyDetMoveNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopBackFM.qyDetScrapNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopBackFM.qyDetScrapPriceChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopBackFM.qyDetSpoilNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopBackFM.qyDetWasteNumChange(Sender: TField);
begin
  inherited;
  GetDet2Num;
end;

procedure TShopBackFM.qyHedCalcFields(DataSet: TDataSet);
begin
  inherited;
...
procedure TShopBackFM.qyHedPrintNumChange(Sender: TField);
begin
  inherited;
  ShowFMInfo(sTableId, qyHed);
end;

procedure TShopBackFM.strngfldDet2ItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TShopBackFM.strngfldDetItemIdChange(Sender: TField);
begin
  inherited;
...
procedure TShopBackFM.strngfldDetTechNameChange(Sender: TField);
var i: integer;
begin
  try
