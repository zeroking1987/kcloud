...
procedure TAccNameQFM.btnCancelClick(Sender: TObject);
begin
  try
    sId := '';
    sName := '';
...
procedure TAccNameQFM.btnCloseClick(Sender: TObject);
begin
  iFlag := 3;
  Close;
end;

procedure TAccNameQFM.btnOKClick(Sender: TObject);
var
  i: Integer;
begin
  try
...
procedure TAccNameQFM.cxDBTreeList1bSelectPropertiesChange(Sender: TObject);
var
  i: Integer;
  sId: string;
begin
...
procedure TAccNameQFM.cxFilterPropertiesChange(Sender: TObject);
begin
  try
...
procedure TAccNameQFM.FormCreate(Sender: TObject);
begin
  try
    sId := '';
    sName := '';
...
procedure TAccNameQFM.FormShow(Sender: TObject);
begin
...
procedure TAccNameQFM.lstTreeListDblClick(Sender: TObject);
begin
  if qyFind.State = dsBrowse then qyFind.Edit;
...
procedure TAccNameQFM.lstTreeListEditValueChanged(Sender: TcxCustomTreeList;
