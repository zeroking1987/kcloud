inherited StockMonthAccountFM: TStockMonthAccountFM
  Caption = #24212#20184#26376#32467
  ClientHeight = 473
  ClientWidth = 689
  ExplicitWidth = 689
  ExplicitHeight = 473
    ...
    inherited cxgrd: TcxGrid
      ...
      inherited cxgrdtbv: TcxGridDBTableView
        ...
        object cxgrdtbvColumn4: TcxGridDBColumn
          ...
          DataBinding.FieldName = 'bStockAccount'
  ...
  inherited qyHed: TADOQuery
    ...
    object qyHedbStockAccount: TBooleanField
      FieldName = 'bStockAccount'
      ReadOnly = True
    end
  end
end
